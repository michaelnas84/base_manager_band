  ...
  return (
    ...
    >
      ...
      <ButtonLink
        ...
        color="white"
        className="mt-8"
        aria-label={`Start with  ${name} by ${price}`}
      >
        Start now
      </ButtonLink>
    </section>
    ...
    >
      ...
      <Container>
        <div className="md:text-center">
          <p className="font-display text-3xl tracking-tight text-white sm:text-4xl">
            <span className="relative whitespace-nowrap">
              ...
              <span className="relative">Simplified price,</span>
            </span>{' '}
            for everybody.
          </p>
          <p className="mt-4 text-lg text-slate-400">
            No matter your band size, our platform is efficient for you!
          </p>
        </div>
        <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-1 xl:mx-0 xl:gap-x-8">
          <Plan
            featured
            name="Unique plan with the first 7 days free"
            price="US$4.99"
            description="Perfect for small/medium/large bands."
            href="/dashboard/web/index_cad_band.php"
            features={[
              'Direct access to devs for new feature implementations',
              'Unlimited number of musicians per band',
              'Unlimited events',
              'Unlimited trials',
              'Access to the ManagerBand global forum',
              '24/7 support',
              'Access to all new platform features',
            ]}
          />
        </div>
      </Container>
