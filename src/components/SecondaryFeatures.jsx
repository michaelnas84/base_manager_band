...
const features = [
  {
    name: 'Management',
    summary:
      "Advantages you can't even imagine",
    description:
      'We definitely recommend you to have a control platform, you will feel really organized and professional',
  ...
  {
    name: 'Control',
    summary: 'Live at the highest quality',
    description:
      'Manage your rehearsals from date/time to specific notes for the moment',
  ...
  },
  {
    ...
    description:
      'Never be in doubt about your team again, with our system you control who, where and when to act for the band',
      ...
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          ...
          <p className="mt-4 text-lg tracking-tight text-slate-700">
            We reduce the time it takes to organize your team with a management platform that has thought of everything.
          </p>
        </div>
        <FeaturesMobile />
        <FeaturesDesktop />
